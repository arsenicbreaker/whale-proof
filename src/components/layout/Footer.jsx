    ...
    <footer className="ico_site_footer section_decoration section_shadow_top">
      ...
      <div className="container">
        <ul className="pagelist_block unordered_list justify-content-center text-uppercase">
          <li>
            <a className="scrollspy_btn" href="#id_ico_about_section">
              <span className="pagelist_label">About WhaleProof</span>
            </a>
          </li>
          <li>
            <a className="scrollspy_btn" href="#id_ico_service_section">
              <span className="pagelist_label">Features</span>
            </a>
          </li>
          <li>
            <a className="scrollspy_btn" href="#id_ico_tokenomics_section">
              <span className="pagelist_label">Tokenomics</span>
            </a>
          </li>
          <li>
            <a className="scrollspy_btn" href="#id_ico_roadmap_section">
              <span className="pagelist_label">Roadmap</span>
            </a>
          </li>
          <li>
            <a className="scrollspy_btn" href="#id_ico_team_section">
              <span className="pagelist_label">Team</span>
            </a>
          </li>
          <li>
            <a className="scrollspy_btn" href="#id_ico_whitepaper_section">
        ...
        <div className="middle_area">
          ...
          <div className="column">
            <h3 className="footer_title text-uppercase">Subscribe to our newslatter</h3>
          ...
          <div className="column">
            <h3 className="footer_title text-uppercase">Let's WhaleProof great together.</h3>
        ...
        <div className="footer_bottom text-center">
          <p className="copyright_text m-0 text-secondary">Copyright© 2026 WhaleProof. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
