...
export default function HeroSection() {
  ...
  return (
    <section
      ...
      style={{
        backgroundImage:
          "url('assets/images/shapes/shape_net_ico_hero_section_bg.svg')",
      }}
    >
      <div className="container">
        <h1 className="hero_title" data-aos="fade-up" data-aos-duration="800">
          Stop Being Whale Food.
        </h1>
        <ul
          ...
          <li>
            <Link className="ico_creative_btn" to={user ? "/dashboard" : "/sign_up"}>
              <span className="btn_wrapper">
                ...
                <span className="btn_label">Start Learning</span>
        ...
        <div data-aos="fade-up" data-aos-duration="600" data-aos-delay="200">
          <div className="ico_countdown_progress_box">
            <div className="ico_heading_block text-center mb-0">
              <h2 className="highlight_title mb-0">Start buy coinpay now!</h2>
            </div>
            <ul
              ...
              style={{
                backgroundImage:
                  "url('assets/images/shapes/shape_bg_ico_countdown.svg')",
              }}
            ></ul>
      ...
      <div className="decoration_item shape_globe">
        <img src="assets/images/shapes/shape_globe.webp" alt="Shape Globe" />
      </div>
      <div className="decoration_item shape_coin">
        <img src="assets/images/shapes/shape_coin.webp" alt="Shape Coin" />
      </div>
    </section>
  );
}
