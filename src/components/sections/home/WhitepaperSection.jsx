          ...
          <div className="row m-0 align-items-center">
            <div className="col-lg-6 p-0">
              <div
                ...
                style={{
                  backgroundImage:
                    "url('assets/images/about/whitepaper_image_bg.webp')",
                }}
              >
                <div className="image_block">
                  <img
                    src="assets/images/about/ico_whitepager_image.webp"
            ...
            <div className="col-lg-6 p-0">
              <div className="whitepaper_info_wrap">
                <div className="info_wrap_1">
                  ...
                  <p>
                    Coinpay has been successfully audited by the trusted
                  ...
                  <ul className="partners_group unordered_list">
                    <li>
                      <div className="ico_partner_logo">
                        <a className="logo_wrap" href="#!">
                          <img
                            src="assets/images/partners/partner_logo_1.svg"
                            alt="Partner Logo"
                          />
                    ...
                    <li>
                      <div className="ico_partner_logo">
                        <a className="logo_wrap" href="#!">
                          <img
                            src="assets/images/partners/partner_logo_2.svg"
                            alt="Partner Logo"
                          />
                          <span className="dot_1"></span>
                          <span className="dot_2"></span>
