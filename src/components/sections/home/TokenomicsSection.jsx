    ...
    <>
      ...
      >
        <div className="container">
          ...
          >
            <h2 className="heading_text mb-0">Coinpay Tokenomics</h2>
          </div>
          ...
          <div className="row align-items-center">
            <div className="col-lg-4 position-relative z-1">
              <ul className="tokenomics_block unordered_list_block">
                ...
                >
                  ...
                  <div className="info">
                    <h4 className="heading_text">Presale</h4>
                    <div className="value">
                      [
                      <span className="odometer" data-count="1200000000">
                        0
                      </span>
                      <span>$</span>]
                    </div>
                ...
                >
                  ...
                  <div className="info">
                    <h4 className="heading_text">CEX & DEX Liquidity</h4>
                    <div className="value">
                      [
                      <span className="odometer" data-count="1200000000">
                        0
                ...
                >
                  ...
                  <div className="info">
                    <h4 className="heading_text">Team</h4>
                    <div className="value">
                      [
                      <span className="odometer" data-count="1200000000">
                        0
                ...
                >
                  ...
                  <div className="info">
                    <h4 className="heading_text">Community Incentives</h4>
                    <div className="value">
                      [
                      <span className="odometer" data-count="1200000000">
                        0
                ...
                >
                  ...
                  <div className="info">
                    <h4 className="heading_text">Marketing</h4>
                    <div className="value">
                      [
                      <span className="odometer" data-count="1200000000">
                        0
            ...
            <div className="col-lg-4">
              <div className="icon_coins_image">
                <img
                  src="assets/images/shapes/ico_coins_image.svg"
                  alt="ICO Coin Image"
                />
              </div>
            </div>
              ...
              <ul className="ico_features_group unordered_list_block">
                ...
                >
                  <div className="ico_iconbox_icon_left">
                    <div className="iconbox_icon">
                      <img
                        src="assets/icons/icon_token_supply.svg"
                        alt="Icon Token Supply"
                      />
                    </div>
                    <div className="iconbox_info">
                      <h3 className="iconbox_title">Total Token Supply</h3>
                ...
                >
                  <div className="ico_iconbox_icon_left">
                    <div className="iconbox_icon">
                      <img
                        src="assets/icons/icon_token_network.svg"
                        alt="Icon Token Network"
                      />
                    </div>
                    <div className="iconbox_info">
                      <h3 className="iconbox_title">Token Network</h3>
                      <p className="iconbox_description mb-0">ERC-20$</p>
                    </div>
                  </div>
                </li>
                <li
                ...
                >
                  <div className="ico_iconbox_icon_left">
                    <div className="iconbox_icon">
                      <img
                        src="assets/icons/icon_estimated_launch_price.svg"
                        alt="Icon Estimated Launch Price"
                      />
                    </div>
                    <div className="iconbox_info">
                      <h3 className="iconbox_title">Estimated Launch price</h3>
                      <p className="iconbox_description mb-0">0.20$</p>
                    </div>
                  </div>
                </li>
                <li
                ...
                >
                  <div className="ico_iconbox_icon_left">
                    <div className="iconbox_icon">
                      <img
                        src="assets/icons/icon_expected_ripple_price.svg"
                        alt="Icon Expected Ripple Price"
                      />
                    </div>
                    <div className="iconbox_info">
                      <h3 className="iconbox_title">Expected Ripple price</h3>
                      <p className="iconbox_description mb-0">0.80 $</p>
                    </div>
                  </div>
                </li>
              </ul>
