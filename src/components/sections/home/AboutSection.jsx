...
export default function AboutSection() {
  return (
    <section
      ...
      className="ico_about_section section_space pb-0 section_decoration"
    >
      <div className="container">
        <div className="row justify-content-lg-between">
          <div className="col-lg-6">
            ...
            >
              <h2 className="heading_text mb-0">Introducing WhaleProof</h2>
            </div>
            <ul className="about_ico_block unordered_list_block">
              <li
                ...
                data-aos-delay="100"
              >
                <h3 className="title_text">What is an WhaleProof?</h3>
                <p className="info_description mb-0">
                  WhaleProof is a financial literacy protocol for retail
                  traders. We replace generic technical analysis with
                  essential money management, fundamental logic, and market
                  survival skills.
                </p>
              </li>
              <li
              ...
              >
                ...
                <p className="info_description mb-0">
                  Most retail traders fail. They jump into trades without a
                  foundation, becoming 'exit liquidity' for institutional
                  giants (Whales). We help you survive market manipulation.
                </p>
              </li>
              <li
                data-aos="fade-up"
                ...
                data-aos-delay="300"
              >
                <h3 className="title_text">How it works?</h3>
                <p className="info_description mb-0">
                  Through interactive, case-based modules, we simulate real
                  market logic. You must prove your survival skills in our
                  'Whale-Proof' simulator before risking your actual capital.
                </p>
              </li>
            </ul>
          </div>
          <div className="col-lg-5 d-lg-flex flex-lg-column-reverse">
            <ul className="about_ico_block unordered_list_block">
              <li
                ...
                data-aos-delay="100"
              >
                <h3 className="title_text">Your Complete Armor</h3>
                <p className="info_description mb-0">
                  Don't just read charts. Master the 3 Pillars of Survival Build a bulletproof mindset against FOMO and panic.
                </p>
              </li>
            </ul>
            <div className="ico_about_image text-center">
              ...
              <div className="coin_image">
                <img
                  src="assets/images/about/about_image.svg"
                  alt="About Image"
                />
              </div>
            </div>
